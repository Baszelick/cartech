# CarTech Assistant — Brand Guidelines
...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#6366F1` | Gradient start, CTA, accents |
| Secondary | `#06B6D4` | Gradient end, hover states |
| Text (light bg) | `#0f172a` | Body text on white/light |
| Text (dark bg) | `#f8fafc` | Body text on dark |
